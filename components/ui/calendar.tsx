	...
	return (
		<DayPicker
			...
			classNames={{
				...
				caption_dropdowns: 'relative inline-flex space-x-6',
				dropdown_month: 'relative inline-flex items-center',
				dropdown_year: 'relative inline-flex items-center',
				caption_label:
					'text-sm font-medium flex items-center cursor-pointer gap-1',
				dropdown:
					'absolute top-0 left-0 z-[2] bottom-0 w-full appearance-none border-none opacity-0 cursor-pointer m-0 p-0 bg-transparent',
				vhidden: 'hidden',
				...
				day_selected:
					'bg-primary-400 text-white hover:bg-primary-400/90 hover:text-slate-50 focus:bg-primary-400 focus:text-white',
